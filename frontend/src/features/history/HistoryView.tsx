    ...
    <div className="flex h-full flex-col">
      ...
      {activeTab ? (
        <div className="flex min-h-0 flex-1 overflow-hidden">
          <aside className="m-2 mr-0 flex h-full min-h-0 w-[280px] shrink-0 flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm">
            <MatchList tab={activeTab} />
          </aside>
          <section className="m-2 flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm">
